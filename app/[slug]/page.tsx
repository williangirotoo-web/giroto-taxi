...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.girototaxiumuarama.com.br/${page.slug}`,
    },
    openGraph: {
      title: page.metaTitle,
      description: page.metaDescription,
      ...
      images: [
        {
          url: `https://www.girototaxiumuarama.com.br${page.heroImage.src}`,
          width: 1200,
          height: 630,
    ...
    "@graph": [
      {
        ...
        image: `https://www.girototaxiumuarama.com.br${page.heroImage.src}`,
        address: {
          "@type": "PostalAddress",
        ...
        itemListElement: [
          {
            ...
            position: 1,
            name: "Início",
            item: "https://www.girototaxiumuarama.com.br",
          },
          {
            "@type": "ListItem",
            position: 2,
            name: page.title,
            item: `https://www.girototaxiumuarama.com.br/${page.slug}`,
          },
        ],
      },
    ],
  ...
  return (
    <>
      ...
      <div className="bg-[#080808] text-white font-sans antialiased min-h-screen">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div>
                ...
                <p className="text-gray-400 text-base md:text-lg mb-7 leading-relaxed">
                  {page.intro}
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="flex items-center justify-center gap-2 bg-green-500 hover:bg-green-400 text-white font-bold px-7 py-4 rounded-2xl text-base transition-all shadow-[0_0_30px_rgba(34,197,94,0.25)]"
                  >
                  ...
                  <a
                    href={PHONE}
                    className="flex items-center justify-center gap-2 border border-white/20 hover:border-yellow-400 hover:text-yellow-400 text-white font-semibold px-7 py-4 rounded-2xl text-base transition-all"
                  >
        ...
        {/* ── S3: GALERIA DESKTOP ONLY ────────────────────────── */}
        <PhotoGallery
          images={page.galleryImages}
          title={`Giroto Táxi — ${page.title} em Umuarama`}
        />
        ...
        <section className="py-16 border-t border-white/5">
          <div className="max-w-6xl mx-auto px-4">
            <h2 className="text-xl md:text-2xl font-bold mb-8 text-center">
              Por que escolher a Giroto Táxi para{" "}
              <span className="text-yellow-400">{page.keyword}</span>?
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
              {page.features.map((f) => (
                <div
                  key={f.title}
                  className="bg-white/5 border border-white/10 hover:border-yellow-400/40 rounded-2xl p-6 transition-all"
                >
                ...
                {page.faq.map((f) => (
                  ...
                  >
                    <summary className="flex items-center justify-between p-6 cursor-pointer font-semibold hover:text-yellow-400 transition-colors list-none">
                      {f.q}
                      <span className="text-yellow-400 text-xl group-open:rotate-45 transition-transform shrink-0 ml-4">
                        +
                      </span>
                    </summary>
        ...
        <section className="py-16 border-t border-white/5">
          <div className="max-w-3xl mx-auto px-4 text-center">
            ...
            <p className="text-gray-400 mb-8">
              Chame agora pelo WhatsApp ou ligue. Atendimento 24 horas em Umuarama.
            </p>
        ...
        <section className="py-16 border-t border-white/5 bg-white/[0.02]">
          <div className="max-w-6xl mx-auto px-4">
            <h2 className="text-xl font-bold mb-6 text-center">
              Outros Serviços de Táxi em Umuarama
            </h2>
